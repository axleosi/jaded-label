      ...
      <div className="w-full space-y-4 p-4 border border-black rounded-md">
        ...
        <div>
          ...
          <input
            ...
            value={address.state}
            onChange={(e) =>
              setAddress((prev) => ({ ...prev, state: e.target.value, lga: '' })) // Reset LGA when state changes
            }
            required
      ...
      <div className="w-full space-y-4 p-4 border border-black rounded-md flex flex-col justify-evenly">
        ...
        <div className="flex justify-between mt-4 w-[90%] mx-auto">
          ...
          <button
            ...
            className="bg-pink-300 text-white px-6 py-2 rounded hover:bg-pink-500 disabled:opacity-50 w-full"
          >
