    ...
    <div className="absolute inset-0 z-50 flex items-start justify-center bg-black bg-opacity-50 px-4 pt-20 sm:pt-32">
      <div className="relative bg-white p-2 rounded-lg shadow-lg w-full md:w-[80%]">
        ...
        <p className="text-sm text-center mb-6 text-gray-600">
          Explore the unique world of jewelry where sophistication is the watchword of our lalacuculala.
        </p>
        ...
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-4">
          ...
          {/* Password and Confirm Password - Side by Side on sm+ */}
          <div className="md:flex sm:gap-4">
          ...
          <p className="text-sm text-center mt-2">
            ...
            <button onClick={switchToLogin} className="text-pink-300 hover:underline">
              Login here
            </button>
          </p>
        </form>
