    ...
    return (
        <div className='relative max-w-6xl w-full px-3 md:px-[5.2rem] mx-auto py-10'>
            ...
            <div className='flex flex-col items-center mt-[11.8rem]'>
                ...
                <div className="mt-[3.125rem] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full">
                    ...
                    {!newLoading && !newError && products.slice(0, 8).map((product, idx) => (
                        <div key={product._id} className="hover:shadow-lg transition-shadow relative group">
